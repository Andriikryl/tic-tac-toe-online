/*
  ...
  - You are about to drop the column `naem` on the `Game` table. All the data in the column will be lost.
...
*/
-- CreateEnum
CREATE TYPE "GameStatus" AS ENUM ('idle', 'inProgress', 'gameOver', 'gameOverDrow');

-- AlterTable
ALTER TABLE "Game" DROP COLUMN "naem",
